...
class HardshipMapperTest {
    ...
    @Test
    void givenWorkflowRequestWithCrownHardship_whenWorkflowRequestIsInvoked_thenMappingIsCorrect() {
        ...
        softly.assertThat(actualHardship.getCourtType()).isEqualTo(CourtType.CROWN_COURT);
        softly.assertThat(actualHardship.getTotalAnnualDisposableIncome().doubleValue())
                .isEqualTo(workflowRequest
                        .getApplicationDTO()
                        .getAssessmentDTO()
    ...
    @Test
    void givenWorkflowRequestWithMagsHardship_whenWorkflowRequestIsInvoked_thenMappingIsCorrect() {
        ...
        softly.assertThat(actualHardship.getCourtType()).isEqualTo(CourtType.MAGISTRATE);
        softly.assertThat(actualHardship.getTotalAnnualDisposableIncome())
                .isEqualTo(expectedHardship.getTotalAnnualDisposableIncome());
        softly.assertThat(actualHardship.getReviewDate()).isEqualTo(expectedHardship.getReviewDate());

        ExtraExpenditure actualExtraExpenditure =
                expectedHardship.getExtraExpenditure().get(0);
        ExtraExpenditure expectedExtraExpenditure =
                actualHardship.getExtraExpenditure().get(0);
    ...
    @Test
    void givenCrownPerformHardshipResponse_whenMappingResponseToApplicationDTO_thenMappingIsCorrect() {
        ApplicationDTO applicationDTO = TestModelDataBuilder.getApplicationDTOWithBlankHardship(CourtType.CROWN_COURT);
        ...
        HardshipReviewDTO crownCourtHardship = applicationDTO
                .getAssessmentDTO()
                .getFinancialAssessmentDTO()
                .getHardship()
    ...
    @Test
    void givenMagsPerformHardshipResponse_whenMappingResponseToApplicationDTOIsInvoked_thenMappingIsCorrect() {
        ApplicationDTO applicationDTO = TestModelDataBuilder.getApplicationDTOWithBlankHardship(CourtType.MAGISTRATE);
        ApiPerformHardshipResponse response = TestModelDataBuilder.getApiPerformHardshipResponse();

        hardshipMapper.performHardshipResponseToApplicationDTO(response, applicationDTO, CourtType.MAGISTRATE);

        HardshipReviewDTO magCourtHardship = applicationDTO
                .getAssessmentDTO()
                .getFinancialAssessmentDTO()
                .getHardship()
                .getMagCourtHardship();
    ...
    private void checkHardshipDTO(ApiPerformHardshipResponse response, HardshipReviewDTO magCourtHardship) {
        ...
        softly.assertThat(magCourtHardship.getReviewResult()).isEqualTo(Constants.HARDSHIP_REVIEW_RESULT);
        softly.assertThat(magCourtHardship.getDisposableIncomeAfterHardship())
                .isEqualTo(Constants.POST_HARDSHIP_DISPOSABLE_INCOME);
        softly.assertThat(magCourtHardship.getDisposableIncome()).isEqualTo(Constants.DISPOSABLE_INCOME);
    }

    private void checkHardshipMetadata(HardshipMetadata actualMetadata, HardshipMetadata other) {
        softly.assertThat(actualMetadata.getRepId()).isEqualTo(other.getRepId());
        softly.assertThat(actualMetadata.getCmuId()).isEqualTo(other.getCmuId());
        softly.assertThat(actualMetadata.getReviewStatus()).isEqualTo(other.getReviewStatus());
        softly.assertThat(actualMetadata.getUserSession()).isEqualTo(other.getUserSession());
        softly.assertThat(actualMetadata.getReviewReason()).isEqualTo(other.getReviewReason());
        softly.assertThat(actualMetadata.getNotes()).isEqualTo(other.getNotes());
        softly.assertThat(actualMetadata.getDecisionNotes()).isEqualTo(other.getDecisionNotes());
        softly.assertThat(actualMetadata.getFinancialAssessmentId()).isEqualTo(other.getFinancialAssessmentId());
        softly.assertThat(actualMetadata.getHardshipReviewId()).isEqualTo(other.getHardshipReviewId());
    }

    private void checkSolicitorCosts(SolicitorCosts actualSolicitorCosts, SolicitorCosts other) {
        softly.assertThat(actualSolicitorCosts.getRate()).isEqualTo(other.getRate());
        softly.assertThat(actualSolicitorCosts.getVat()).isEqualTo(other.getVat());
        softly.assertThat(actualSolicitorCosts.getHours()).isEqualTo(other.getHours());
        softly.assertThat(actualSolicitorCosts.getDisbursements()).isEqualTo(other.getDisbursements());
        softly.assertThat(actualSolicitorCosts.getEstimatedTotal()).isEqualTo(other.getEstimatedTotal());
    }

    private void checkDeniedIncome(DeniedIncome actualDeniedIncome, DeniedIncome other) {
        softly.assertThat(actualDeniedIncome.getAmount()).isEqualTo(other.getAmount());
        softly.assertThat(actualDeniedIncome.getFrequency()).isEqualTo(other.getFrequency());
        softly.assertThat(actualDeniedIncome.getAccepted()).isEqualTo(other.getAccepted());
        softly.assertThat(actualDeniedIncome.getReasonNote()).isEqualTo(other.getReasonNote());
        softly.assertThat(actualDeniedIncome.getDescription()).isEqualTo(other.getDescription());
        softly.assertThat(actualDeniedIncome.getItemCode()).isEqualTo(other.getItemCode());
    }

    private void checkExtraExpenditure(ExtraExpenditure actualExtraExpenditure, ExtraExpenditure other) {
        softly.assertThat(actualExtraExpenditure.getAmount()).isEqualTo(other.getAmount());
        softly.assertThat(actualExtraExpenditure.getFrequency()).isEqualTo(other.getFrequency());
        softly.assertThat(actualExtraExpenditure.getDescription()).isEqualTo(other.getDescription());
        softly.assertThat(actualExtraExpenditure.getAccepted()).isEqualTo(other.getAccepted());
        softly.assertThat(actualExtraExpenditure.getReasonCode()).isEqualTo(other.getReasonCode());
        softly.assertThat(actualExtraExpenditure.getItemCode()).isEqualTo(other.getItemCode());
    }

    @Test
    void givenWorkflowRequestAndAction_whengetUserActionDTOIsInvoked_thenMappingIsCorrect() {
        WorkflowRequest workflowRequest = TestModelDataBuilder.buildWorkflowRequestWithHardship(CourtType.MAGISTRATE);
        UserActionDTO actual = hardshipMapper.getUserActionDTO(workflowRequest, TestModelDataBuilder.TEST_ACTION);
