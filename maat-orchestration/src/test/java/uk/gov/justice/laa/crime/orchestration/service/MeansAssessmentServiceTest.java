...
class MeansAssessmentServiceTest {
    ...
    void givenFinancialAssessmentId_whenFindIsInvoked_thenApiServiceIsCalledAndResponseMapped() {
        ...
        verify(meansAssessmentMapper)
                .getMeansAssessmentResponseToFinancialAssessmentDto(any(ApiGetMeansAssessmentResponse.class), anyInt());
    }
    ...
    void givenWorkflowRequest_whenCreateIsInvoked_thenRequestIsMappedAndApiServiceIsCalled() {
        ApiCreateMeansAssessmentRequest apiCreateMeansAssessmentRequest =
                MeansAssessmentDataBuilder.getApiCreateMeansAssessmentRequest();
    ...
    void givenWorkflowRequest_whenUpdateIsInvoked_thenRequestIsMappedAndApiServiceIsCalled() {
        ApiUpdateMeansAssessmentRequest apiUpdateMeansAssessmentRequest =
                MeansAssessmentDataBuilder.getApiUpdateMeansAssessmentRequest();
