...
class ValidationServiceTest {
    ...
    private static Stream<Arguments> restrictedFieldsNotEditableByUser() {
        return Stream.of(
                Arguments.of(RestrictedField.APPEAL_CC_OUTCOME), Arguments.of(RestrictedField.APPEAL_RECEIVED_DATE));
    }
    ...
    private static Stream<Arguments> validateApplicationTimestamp() {
        return Stream.of(
                Arguments.of(
                        TestModelDataBuilder.buildWorkflowRequestForApplicationTimestampValidation(Optional.empty()),
                        TestModelDataBuilder.buildRepOrderDTOWithModifiedDate()),
                Arguments.of(
                        TestModelDataBuilder.buildWorkflowRequestForApplicationTimestampValidation(Optional.empty()),
                        TestModelDataBuilder.buildRepOrderDTOWithCreatedDateAndNoModifiedDate()));
    }

    private static Stream<Arguments> validateApplicationStatus() {
        return Stream.of(Arguments.of(
                TestModelDataBuilder.buildWorkFlowRequest(false),
                TestModelDataBuilder.buildRepOrderDTO(RepOrderStatus.ERR.getCode())));
    }

    private static Stream<Arguments> validateApplicationStatusNoException() {
        return Stream.of(
                Arguments.of(
                        TestModelDataBuilder.buildWorkFlowRequest(true),
                        TestModelDataBuilder.buildRepOrderDTO(RepOrderStatus.ERR.getCode())),
                Arguments.of(
                        TestModelDataBuilder.buildWorkFlowRequest(false), TestModelDataBuilder.buildRepOrderDTO(null)),
                Arguments.of(
                        TestModelDataBuilder.buildWorkFlowRequest(true),
    ...
    void validateApplicationTimestamp_whenApplicationTimestampIsNull_thenNoExceptionIsThrow() {
        ...
        Assertions.assertThatCode(() -> validationService.validate(workflowRequest, repOrderDTO))
    ...
    void validateApplicationTimestamp_whenApplicationAndRepOrderTimestampsAreEqual_thenNoExceptionIsThrown() {
        ...
        WorkflowRequest workflowRequest =
                TestModelDataBuilder.buildWorkflowRequestForApplicationTimestampValidation(Optional.of(timestamp));
    ...
    @Test
    void validateApplicationTimestamp_whenTimestampsAreEqualExceptMilliseconds_thenNoExceptionIsThrown() {
        String applicationTimestamp = "2024-07-26T10:41:02.515";
        String repOrderTimestamp = "2024-07-26T10:41:02.314";

        WorkflowRequest workflowRequest = TestModelDataBuilder.buildWorkflowRequestForApplicationTimestampValidation(
                Optional.of(applicationTimestamp));
    ...
    void validateApplicationTimestamp_whenApplicationHasBeenModifiedByAnotherUser_thenExceptionIsThrown(
            final WorkflowRequest workflowRequest, final RepOrderDTO repOrderDTO) {
        assertThatThrownBy(() -> validationService.validate(workflowRequest, repOrderDTO))
                .hasMessageContaining(CANNOT_MODIFY_APPLICATION_ERROR);
    }
    ...
    void validateApplicationStatus(final WorkflowRequest workflowRequest, final RepOrderDTO repOrderDTO) {
        assertThatThrownBy(() -> validationService.validate(workflowRequest, repOrderDTO))
                .hasMessageContaining("Cannot update case in status of");
    }
    ...
    @Test
    void givenInputWithExistingReservation_whenIsUserActionValidIsInvoked_thenExceptionIsThrown()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();

        assertThatThrownBy(() -> validationService.isUserActionValid(
                        TestModelDataBuilder.getUserActionDTOWithReservation(), userSummaryDTO))
    ...
    @Test
    void givenInputWithRoleActionNotAssignedToUser_whenIsUserActionValidIsInvoked_thenExceptionIsThrown()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();
    ...
    @Test
    void givenInputWithNewWorkReasonNotAssignedToUser_whenIsUserActionValidIsInvoked_thenExceptionIsThrown()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();
        UserActionDTO userActionDTO = TestModelDataBuilder.getUserActionDTOWithReservation();
    ...
    @Test
    void givenParametersWithNoExistingReservation_whenIsUserActionValidIsInvoked_thenValidationStatusIsReturned()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();
    ...
    @Test
    void givenNoRoleActionAndNewWorkReasonWithExistingReservation_whenIsUserActionValidIsInvoked_thenExceptionIsThrown()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();
        ...
        assertThatThrownBy(() -> validationService.isUserActionValid(userActionDTO, userSummaryDTO))
                ...
                .extracting("exceptionMessages", InstanceOfAssertFactories.ITERABLE)
                .contains(
                        USER_DOES_NOT_HAVE_A_VALID_NEW_WORK_REASON_CODE,
                        USER_DOES_NOT_HAVE_A_ROLE_CAPABLE_OF_PERFORMING_THIS_ACTION,
                        USER_HAVE_AN_EXISTING_RESERVATION_RESERVATION_NOT_ALLOWED);
    }

    @Test
    void givenNoRoleActionAndNoNewWorkReason_whenIsUserActionValidIsInvoked_thenExceptionIsThrown()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();
    ...
    @Test
    void givenNoRoleActionAndExistingReservation_whenIsUserActionValidIsInvoked_thenExceptionIsThrown()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();
    ...
    @Test
    void givenNoNewWorkReasonAndExistingReservation_whenIsUserActionValidIsInvoked_thenExceptionIsThrown()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();
    ...
    @Test
    void givenValidInputAndWithNoRoleActionsForUser_whenIsUserActionValidIsInvoked_thenExceptionIsThrown()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();
    ...
    @Test
    void givenValidInputAndWithNewWorkReasonForUser_whenIsUserActionValidIsInvoked_thenExceptionIsThrown()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();
    ...
    @Test
    void givenValidInputAndWithDifferentSessionIdForUser_whenIsUserActionValidIsInvoked_thenFalseIsReturned()
            throws CrimeValidationException {
        UserSummaryDTO userSummaryDTO = TestModelDataBuilder.getUserSummaryDTO();
    ...
    @Test
    void givenValidInputWithOnlyRoleAction_whenIsUserActionValidIsInvoked_thenOKResponseIsReturned()
            throws CrimeValidationException {
        UserActionDTO userActionDTO = TestModelDataBuilder.getUserActionDTO();
    ...
    @Test
    void givenValidInputWithOnlyNewWorkReason_whenIsUserActionValidIsInvoked_thenOKResponseIsReturned()
            throws CrimeValidationException {
        UserActionDTO userActionDTO = TestModelDataBuilder.getUserActionDTO();
    ...
    @Test
    void givenValidInputWithOnlySessionId_whenIsUserActionValidIsInvoked_thenOKResponseIsReturned()
            throws CrimeValidationException {
        UserActionDTO userActionDTO = TestModelDataBuilder.getUserActionDTOWithReservation();
        userActionDTO.setAction(null);
        userActionDTO.setNewWorkReason(null);
        ...
        assertThat(validationService.isUserActionValid(userActionDTO, userSummaryDTO))
                .isTrue();
    }

    @Test
    void givenValidInputWithNoReservation_whenIsUserActionValidIsInvoked_thenOKResponseIsReturned()
            throws CrimeValidationException {
        UserActionDTO userActionDTO = TestModelDataBuilder.getUserActionDTO();
        userActionDTO.setAction(null);
        userActionDTO.setNewWorkReason(null);
    ...
    void givenUserHasNoPermissions_whenIsUserAuthorisedToEditFieldIsInvoked_thenReturnsFalse() {
        ...
        boolean result =
                validationService.isUserAuthorisedToEditField(userSummaryDTO, RestrictedField.APPEAL_CC_OUTCOME);
    ...
    void givenUserHasNoRoleWhichHasPermissionToEdit_whenIsUserAuthorisedToEditFieldIsInvoked_thenReturnsFalse(
            final RestrictedField restrictedField) {
        List<RoleDataItemDTO> roleDataItems = List.of(new RoleDataItemDTO(
                "CCMT CASEWORKER", RestrictedField.APPEAL_CC_OUTCOME.getField(), "N", null, null, null));
    ...
    void givenUserHasPermissionButPermissionIsDisabled_whenIsUserAuthorisedToEditFieldIsInvoked_thenReturnsFalse() {
        List<RoleDataItemDTO> roleDataItems = List.of(
                new RoleDataItemDTO(
                        "CCMT CASEWORKER", RestrictedField.APPEAL_CC_OUTCOME.getField(), "N", null, null, "N"),
                new RoleDataItemDTO(
                        "CCMT CASEWORKER", RestrictedField.APPEAL_RECEIVED_DATE.getField(), "N", "Y", "N", "N"),
                new RoleDataItemDTO(
                        "CCMT CASEWORKER", RestrictedField.APPEAL_RECEIVED_DATE.getField(), "N", "N", "Y", "N"));
    ...
    void givenUserHasPermission_whenIsUserAuthorisedToEditFieldIsInvoked_thenReturnsTrue(
            final RestrictedField restrictedField) {
        List<RoleDataItemDTO> roleDataItems = List.of(
                new RoleDataItemDTO(
                        "CCMT CASEWORKER", RestrictedField.APPEAL_CC_OUTCOME.getField(), "N", null, null, "Y"),
                new RoleDataItemDTO(
                        "CCMT CASEWORKER", RestrictedField.APPEAL_RECEIVED_DATE.getField(), "Y", "Y", "N", "Y"),
                new RoleDataItemDTO(
                        "CCMT CASEWORKER", RestrictedField.APPEAL_SENTENCE_ORDER_DATE.getField(), "Y", "N", "Y", "Y"),
                new RoleDataItemDTO(
                        "CCMT CASEWORKER", RestrictedField.APPEAL_CC_WITHDRAWAL_DATE.getField(), "Y", "Y", "Y", "Y"));
    ...
    void givenUserHasUpliftPermissions_whenCheckUpliftFieldPermissionsIsInvoked_thenNoExceptionIsThrown() {
        ...
        Assertions.assertThatCode(() -> validationService.checkUpliftFieldPermissions(userSummaryDTO))
                .doesNotThrowAnyException();
    }
}
