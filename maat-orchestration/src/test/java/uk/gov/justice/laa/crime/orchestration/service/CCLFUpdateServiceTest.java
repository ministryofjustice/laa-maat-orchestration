...
class CCLFUpdateServiceTest {
    ...
    void givenValidInputWithUpdateAction_whenUpdateSendToCCLFIsInvoked_thenNoExceptionIsThrown() {
        WorkflowRequest workflowRequest = TestModelDataBuilder.buildWorkFlowRequest();
        RepOrderDTO repOrderDTO = TestModelDataBuilder.buildRepOrderDTO("CURR");
        Assertions.assertThatCode(() -> cclfUpdateService.updateSendToCCLF(workflowRequest, repOrderDTO))
    ...
    void givenValidInputWithDifferentObject_whenCompareRepOrderAndApplicationDTOIsInvoked_thenOKResponseIsReturned() {
        WorkflowRequest workflowRequest = TestModelDataBuilder.buildWorkFlowRequest();
        RepOrderDTO repOrderDTO = TestModelDataBuilder.buildRepOrderDTO("CURR");
        assertThat(cclfUpdateService.compareRepOrderAndApplicationDTO(repOrderDTO, workflowRequest.getApplicationDTO()))
                .isFalse();
    }
    ...
    void givenValidInput_whenGetWithdrawalDateIsInvoked_thenOKResponseIsReturned() {
        ApplicationDTO applicationDTO =
                TestModelDataBuilder.buildWorkFlowRequest().getApplicationDTO();
        applicationDTO
                .getCrownCourtOverviewDTO()
                .getCrownCourtSummaryDTO()
                .setCcWithDrawalDate(Date.from(
                        CC_WITHDRAWAL_DATETIME.atZone(ZoneId.systemDefault()).toInstant()));
        assertThat(cclfUpdateService.getWithDrawalDate(applicationDTO))
                .isEqualTo(LocalDate.from(CC_WITHDRAWAL_DATETIME));
    }
    ...
    void givenValidInput_whenGetAppealTypeIsInvoked_thenValidResponseIsReturned() {
        ...
        applicationDTO
                ...
                .getAppealDTO()
                .getAppealTypeDTO()
                .setCode(AppealType.ACS.getCode());
    ...
    void givenValidInput_whenGetOutcomeIsInvoked_thenValidResponseIsReturned() {
        ...
        applicationDTO
                .getCrownCourtOverviewDTO()
                .getCrownCourtSummaryDTO()
                .setCcOutcome(TestModelDataBuilder.getOutcomeDTO());
