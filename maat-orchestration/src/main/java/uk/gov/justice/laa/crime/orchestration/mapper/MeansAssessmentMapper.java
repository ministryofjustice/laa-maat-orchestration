...
import uk.gov.justice.laa.crime.orchestration.dto.maat.ContraryInterestDTO;
...
public class MeansAssessmentMapper {
    ...
    public ApiCreateMeansAssessmentRequest workflowRequestToCreateAssessmentRequest(WorkflowRequest request) {
        ...
        return new ApiCreateMeansAssessmentRequest()
                ...
                .withAssessmentStatus(
                        CurrentStatus.getFrom(initial.getAssessmnentStatusDTO().getStatus()))
                ...
                .withIncomeEvidenceSummary(incomeEvidenceSummaryBuilder(financialAssessmentDTO.getIncomeEvidence()))
                ...
                .withPartnerContraryInterest(isPartnerContraryInterest(application))
                ...
                .withNewWorkReason(
                        NewWorkReason.getFrom(initial.getNewWorkReason().getCode()))
    ...
    public ApiUpdateMeansAssessmentRequest workflowRequestToUpdateAssessmentRequest(WorkflowRequest request) {
        ...
        return new ApiUpdateMeansAssessmentRequest()
                ...
                .withNewWorkReason(
                        assessmentType == AssessmentType.INIT
                                ? NewWorkReason.getFrom(
                                        initialAssessmentDTO.getNewWorkReason().getCode())
                                : null)
                .withSectionSummaries(sectionSummariesBuilder(
                        assessmentType == AssessmentType.FULL
                                ? fullAssessmentDTO.getSectionSummaries()
    ...
    private List<ApiIncomeEvidence> mapIncomeEvidence(ApplicationDTO applicationDTO) {
        ...
        List<ApiIncomeEvidence> incomeEvidence =
                new ArrayList<>(incomeEvidenceSummary.getApplicantIncomeEvidenceList().stream()
        ...
        incomeEvidence.addAll(incomeEvidenceSummary.getExtraEvidenceList().stream()
                .map(evidenceItem -> mapToExtraApiIncomeEvidence(evidenceItem, applicationDTO, partnerId.orElse(null)))
                .toList());
    ...
    private ApiIncomeEvidence mapToApiIncomeEvidence(EvidenceDTO evidenceItem, int applicantId) {
        return new ApiIncomeEvidence()
                ...
                .withDateReceived(toLocalDateTime(evidenceItem.getDateReceived()))
                .withIncomeEvidence(evidenceItem.getEvidenceTypeDTO().getEvidence())
                .withApplicantId(applicantId);
    }

    private ApiIncomeEvidence mapToExtraApiIncomeEvidence(
            ExtraEvidenceDTO evidenceItem, ApplicationDTO applicationDTO, Integer partnerId) {
        ...
        if (sectionSummaries != null) {
            for (AssessmentSectionSummaryDTO sectionSummaryDTO : sectionSummaries) {
                ...
                BigDecimal annualTotal = sectionSummaryDTO.getAnnualTotal() != null
                        ? BigDecimal.valueOf(sectionSummaryDTO.getAnnualTotal())
                        : null;
                ...
                BigDecimal partnerAnnualTotal = sectionSummaryDTO.getPartnerAnnualTotal() != null
                        ? BigDecimal.valueOf(sectionSummaryDTO.getPartnerAnnualTotal())
                        : null;

                apiAssessmentSectionSummaries.add(new ApiAssessmentSectionSummary()
    ...
    public List<ApiAssessmentDetail> assessmentDetailsBuilder(Collection<AssessmentDetailDTO> assessmentDetails) {
        ...
        if (assessmentDetails != null) {
            for (AssessmentDetailDTO assessmentDetailDTO : assessmentDetails) {
                apiAssessmentDetails.add(new ApiAssessmentDetail()
                        ...
                        .withApplicantFrequency(Frequency.getFrom(
                                assessmentDetailDTO.getApplicantFrequency().getCode()))
                        ...
                        .withPartnerFrequency(Frequency.getFrom(
                                assessmentDetailDTO.getPartnerFrequency().getCode())));
            }
        }
    ...
    public FinancialAssessmentDTO getMeansAssessmentResponseToFinancialAssessmentDto(
        ...
        return FinancialAssessmentDTO.builder()
                ...
                .criteriaId(ofNullable(apiResponse.getCriteriaId())
    ...
    public UserActionDTO getUserActionDto(WorkflowRequest request, Action action) {
        ...
        NewWorkReason newWorkReason = assessmentType == AssessmentType.INIT
                ? NewWorkReason.getFrom(initialAssessment.getNewWorkReason().getCode())
                : null;

        return userMapper.getUserActionDTO(request, action, newWorkReason);
    }

    private IncomeEvidenceSummaryDTO incomeEvidenceSummaryToDto(
    ...
    public EvidenceDTO getEvidenceDTO(ApiIncomeEvidence apiIncomeEvidence) {
        ...
        evidenceDTO.setId(
                ofNullable(apiIncomeEvidence.getId()).map(Integer::longValue).orElse(0L));
    ...
    private EvidenceTypeDTO getEvidenceTypeDTO(String incomeEvidence) {
        ...
        if (StringUtils.isNotBlank(incomeEvidence)) {
            ...
            evidenceTypeDTO.setDescription(
                    IncomeEvidenceType.getFrom(incomeEvidence).getDescription());
        }
    ...
    private InitialAssessmentDTO initialAssessmentToDTO(ApiInitialMeansAssessment apiInitialMeansAssessment) {
        return InitialAssessmentDTO.builder()
                .id(ofNullable(apiInitialMeansAssessment.getId())
                        .map(Integer::longValue)
                        .orElse(0L))
                .adjustedIncomeValue(ofNullable(apiInitialMeansAssessment.getAdjustedIncomeValue())
                ...
                .lowerThreshold(ofNullable(apiInitialMeansAssessment.getLowerThreshold())
                        .map(BigDecimal::doubleValue)
                        .orElse(0.0))
                ...
                .totalAggregatedIncome(ofNullable(apiInitialMeansAssessment.getTotalAggregatedIncome())
                        .map(BigDecimal::doubleValue)
                        .orElse(0.0))
                .upperThreshold(ofNullable(apiInitialMeansAssessment.getUpperThreshold())
                        .map(BigDecimal::doubleValue)
                        .orElse(0.0))
                .build();
    }
    ...
    public static List<ChildWeightingDTO> mapChildWeightings(List<ApiAssessmentChildWeighting> childWeightings) {
        ...
        for (ApiAssessmentChildWeighting apiAssessmentChildWeighting : childWeightings) {
            ...
            childWeightingDTO.setId(ofNullable(apiAssessmentChildWeighting.getId())
                    .map(Integer::longValue)
                    .orElse(0L));
            childWeightingDTO.setWeightingId(ofNullable(apiAssessmentChildWeighting.getChildWeightingId())
                    .map(Integer::longValue)
                    .orElse(0L));
            childWeightingDTO.setWeightingFactor(ofNullable(apiAssessmentChildWeighting.getWeightingFactor())
                    .map(BigDecimal::doubleValue)
                    .orElse(0.0));
    ...
    private FullAssessmentDTO fullAssessmentToDto(ApiFullMeansAssessment apiFullMeansAssessment) {
        return FullAssessmentDTO.builder()
                .adjustedLivingAllowance(ofNullable(apiFullMeansAssessment.getAdjustedLivingAllowance())
                        .map(BigDecimal::doubleValue)
                        .orElse(0.0))
                ...
                .criteriaId(ofNullable(apiFullMeansAssessment.getCriteriaId())
                        .map(Integer::longValue)
                        .orElse(0L))
                .otherHousingNote(apiFullMeansAssessment.getOtherHousingNote())
                .result(ofNullable(apiFullMeansAssessment.getResult())
                        .map(String::toString)
                        .orElse(""))
                .resultReason(ofNullable(apiFullMeansAssessment.getResultReason())
                        .map(String::toString)
                        .orElse(""))
                .sectionSummaries(getSectionSummaries(apiFullMeansAssessment.getAssessmentSectionSummary()))
                .threshold(ofNullable(apiFullMeansAssessment.getThreshold())
                        .map(BigDecimal::doubleValue)
                        .orElse(0.0))
                .totalAggregatedExpense(ofNullable(apiFullMeansAssessment.getTotalAggregatedExpense())
                        .map(BigDecimal::doubleValue)
                        .orElse(0.0))
                .totalAnnualDisposableIncome(ofNullable(apiFullMeansAssessment.getTotalAnnualDisposableIncome())
                        .map(BigDecimal::doubleValue)
                        .orElse(0.0))
                .build();
    }
    ...
    private static List<AssessmentSectionSummaryDTO> getSectionSummaries(
        ...
        for (ApiAssessmentSectionSummary apiAssessmentSectionSummary : assessmentSectionSummary) {
            ...
            assessmentSectionSummaryDTO.setAnnualTotal(ofNullable(apiAssessmentSectionSummary.getAnnualTotal())
                    .map(BigDecimal::doubleValue)
                    .orElse(0.0));
            assessmentSectionSummaryDTO.setApplicantAnnualTotal(
                    ofNullable(apiAssessmentSectionSummary.getApplicantAnnualTotal())
                            .map(BigDecimal::doubleValue)
                            .orElse(0.0));
            assessmentSectionSummaryDTO.setPartnerAnnualTotal(
                    ofNullable(apiAssessmentSectionSummary.getPartnerAnnualTotal())
                            .map(BigDecimal::doubleValue)
                            .orElse(0.0));
    ...
    private static List<AssessmentDetailDTO> getSectionDetail(List<ApiAssessmentDetail> assessmentDetailList) {
        ...
        for (ApiAssessmentDetail apiAssessmentDetail : assessmentDetailList) {
            ...
            assessmentDetailDTO.setPartnerAmount(ofNullable(apiAssessmentDetail.getPartnerAmount())
                    .map(BigDecimal::doubleValue)
                    .orElse(0.0));
            assessmentDetailDTO.setApplicantAmount(ofNullable(apiAssessmentDetail.getApplicantAmount())
                    .map(BigDecimal::doubleValue)
                    .orElse(0.0));
            assessmentDetailDTO.setCriteriaDetailsId(ofNullable(apiAssessmentDetail.getCriteriaDetailId())
                    .map(Integer::longValue)
                    .orElse(0L));
            assessmentDetailDTO.setId(ofNullable(apiAssessmentDetail.getId())
                    .map(Integer::longValue)
                    .orElse(0L));
    ...
    public void meansAssessmentResponseToApplicationDto(
            final ApiMeansAssessmentResponse apiResponse, ApplicationDTO applicationDTO) {
        ...
        if (Boolean.TRUE.equals(
                applicationDTO.getAssessmentDTO().getFinancialAssessmentDTO().getFullAvailable())) {
            ...
            // Temp fix, wipe the income evidence before progressing until we can populate from means assessment
            // response
            IncomeEvidenceSummaryDTO incomeEvidence = applicationDTO
                    .getAssessmentDTO()
    ...
    private void mapFullAssessmentDTO(FullAssessmentDTO fullAssessmentDTO, ApiMeansAssessmentResponse apiResponse) {
        fullAssessmentDTO.setResult(
                ofNullable(apiResponse.getFullResult()).map(String::toString).orElse(""));
        fullAssessmentDTO.setAdjustedLivingAllowance(ofNullable(apiResponse.getAdjustedLivingAllowance())
                .map(BigDecimal::doubleValue)
                .orElse(0.0));
        fullAssessmentDTO.setResultReason(ofNullable(apiResponse.getFullResultReason())
                .map(String::toString)
                .orElse(""));
        fullAssessmentDTO.setTotalAggregatedExpense(ofNullable(apiResponse.getTotalAggregatedExpense())
                .map(BigDecimal::doubleValue)
                .orElse(0.0));
        fullAssessmentDTO.setTotalAnnualDisposableIncome(ofNullable(apiResponse.getTotalAnnualDisposableIncome())
                .map(BigDecimal::doubleValue)
                .orElse(0.0));
        fullAssessmentDTO.setThreshold(ofNullable(apiResponse.getFullThreshold())
                .map(BigDecimal::doubleValue)
                .orElse(0.0));
        mapSectionSummaries(fullAssessmentDTO.getSectionSummaries(), apiResponse.getAssessmentSectionSummary());
    }

    private void mapInitialAssessmentDTO(
            InitialAssessmentDTO initialAssessmentDTO, ApiMeansAssessmentResponse apiResponse) {
        initialAssessmentDTO.setLowerThreshold(ofNullable(apiResponse.getLowerThreshold())
                .map(BigDecimal::doubleValue)
                .orElse(0.0));
        initialAssessmentDTO.setUpperThreshold(ofNullable(apiResponse.getUpperThreshold())
                .map(BigDecimal::doubleValue)
                .orElse(0.0));
        initialAssessmentDTO.setTotalAggregatedIncome(ofNullable(apiResponse.getTotalAggregatedIncome())
                .map(BigDecimal::doubleValue)
                .orElse(0.0));
        initialAssessmentDTO.setAdjustedIncomeValue(ofNullable(apiResponse.getAdjustedIncomeValue())
                .map(BigDecimal::doubleValue)
                .orElse(0.0));
        initialAssessmentDTO.setResult(
                ofNullable(apiResponse.getInitResult()).map(String::toString).orElse(""));
        initialAssessmentDTO.setResultReason(ofNullable(apiResponse.getInitResultReason())
                .map(String::toString)
                .orElse(""));
        initialAssessmentDTO.setCriteriaId(
                ofNullable(apiResponse.getCriteriaId()).map(Integer::longValue).orElse(0L));
        initialAssessmentDTO.setId(ofNullable(apiResponse.getAssessmentId())
                .map(Integer::longValue)
                .orElse(0L));
    ...
    private void updateChildWeightingsId(
            Collection<ChildWeightingDTO> childWeightingDTOCollection,
        ...
        for (ApiAssessmentChildWeighting responseChildWeighting : apiAssessmentChildWeightingList) {
            for (ChildWeightingDTO childWeightingDTO : childWeightingDTOCollection) {
                if (responseChildWeighting
                        .getChildWeightingId()
                        .equals(childWeightingDTO.getWeightingId().intValue())) {
                    childWeightingDTO.setId(ofNullable(responseChildWeighting.getId())
                            .map(Integer::longValue)
                            .orElse(0L));
                }
            }
    ...
    private void mapSectionSummaries(
            Collection<AssessmentSectionSummaryDTO> sectionSummaries,
            ...
            for (ApiAssessmentSectionSummary assessmentSectionSummary : assessmentSectionSummaries) {
                for (AssessmentSectionSummaryDTO assessmentSectionSummaryDTO : sectionSummaries) {
                    if (assessmentSectionSummary.getSection().equals(assessmentSectionSummaryDTO.getSection())) {
                        assessmentSectionSummaryDTO.setAnnualTotal(ofNullable(assessmentSectionSummary.getAnnualTotal())
                                .map(BigDecimal::doubleValue)
                                .orElse(0.0));
                        assessmentSectionSummaryDTO.setApplicantAnnualTotal(
                                ofNullable(assessmentSectionSummary.getApplicantAnnualTotal())
                                        .map(BigDecimal::doubleValue)
                                        .orElse(0.0));
                        assessmentSectionSummaryDTO.setPartnerAnnualTotal(
                                ofNullable(assessmentSectionSummary.getPartnerAnnualTotal())
                                        .map(BigDecimal::doubleValue)
                                        .orElse(0.0));
                        mapAssessmentDetail(
                                assessmentSectionSummaryDTO.getAssessmentDetail(),
    ...
    private void mapAssessmentDetail(
            Collection<AssessmentDetailDTO> assessmentDetail, List<ApiAssessmentDetail> assessmentDetailList) {
        if (assessmentDetailList != null) {
            for (ApiAssessmentDetail apiAssessmentDetail : assessmentDetailList) {
                for (AssessmentDetailDTO assessmentDetailDTO : assessmentDetail) {
                    if (apiAssessmentDetail
                            .getCriteriaDetailId()
    ...
    public void apiRollbackMeansAssessmentResponseToApplicationDto(
            ApiRollbackMeansAssessmentResponse response, ApplicationDTO applicationDTO) {
        if (AssessmentType.INIT.getType().equals(response.getAssessmentType())) {
            InitialAssessmentDTO initialAssessmentDTO = applicationDTO
                    .getAssessmentDTO()
                    .getFinancialAssessmentDTO()
                    .getInitial();
            ...
            FullAssessmentDTO fullAssessmentDTO = applicationDTO
                    .getAssessmentDTO()
                    .getFinancialAssessmentDTO()
                    .getFull();
