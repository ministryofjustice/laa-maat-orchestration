...
public class WebClientsConfiguration {
    ...
    WebClient crownCourtProceedingWebClient(
            WebClient.Builder webClientBuilder,
            ServicesConfiguration servicesConfiguration,
            ClientRegistrationRepository clientRegistrations,
            OAuth2AuthorizedClientRepository authorizedClients,
    ...
    WebClient crownCourtContributionsWebClient(
            WebClient.Builder webClientBuilder,
            ServicesConfiguration servicesConfiguration,
            ClientRegistrationRepository clientRegistrations,
            OAuth2AuthorizedClientRepository authorizedClients,
    ...
    WebClient crimeMeansAssessmentWebClient(
            WebClient.Builder webClientBuilder,
            ServicesConfiguration servicesConfiguration,
            ClientRegistrationRepository clientRegistrations,
            OAuth2AuthorizedClientRepository authorizedClients,
    ...
    WebClient applicationTrackingWebClient(
            WebClient.Builder webClientBuilder,
            ServicesConfiguration servicesConfiguration,
            ClientRegistrationRepository clientRegistrations,
            OAuth2AuthorizedClientRepository authorizedClients,
    ...
    HardshipApiClient hardshipApiClient(@Qualifier("hardshipWebClient") WebClient hardshipWebClient) {
        HttpServiceProxyFactory httpServiceProxyFactory = HttpServiceProxyFactory.builderFor(
                        WebClientAdapter.create(hardshipWebClient))
                .build();
    ...
    CrownCourtContributionsApiClient crownCourtContributionsApiClient(
        ...
        HttpServiceProxyFactory httpServiceProxyFactory = HttpServiceProxyFactory.builderFor(
                        WebClientAdapter.create(crownCourtContributionsWebClient))
                .build();
    ...
    CrownCourtProceedingApiClient crownCourtProceedingApiClient(
        ...
        HttpServiceProxyFactory httpServiceProxyFactory = HttpServiceProxyFactory.builderFor(
                        WebClientAdapter.create(crownCourtProceedingWebClient))
                .build();
    ...
    CrimeMeansAssessmentApiClient crimeMeansAssessmentApiClient(
        ...
        HttpServiceProxyFactory httpServiceProxyFactory = HttpServiceProxyFactory.builderFor(
                        WebClientAdapter.create(crimeMeansAssessmentWebClient))
                .build();
