package uk.gov.justice.laa.crime.orchestration.mapper.meansassessment;
...
import uk.gov.justice.laa.crime.orchestration.enums.AssessmentType;
...
import uk.gov.justice.laa.crime.orchestration.enums.ReviewType;
...
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiAssessmentChildWeighting;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiAssessmentDetail;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiAssessmentSectionSummary;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiAssessmentStatus;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiCreateMeansAssessmentRequest;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiEvidenceType;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiFullMeansAssessment;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiGetMeansAssessmentResponse;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiIncomeEvidence;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiIncomeEvidenceSummary;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiInitialMeansAssessment;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiMeansAssessmentResponse;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiNewWorkReason;
import uk.gov.justice.laa.crime.orchestration.model.means_assessment.ApiReviewType;
