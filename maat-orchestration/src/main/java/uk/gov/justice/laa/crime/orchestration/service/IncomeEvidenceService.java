...
public class IncomeEvidenceService {
    ...
    public void createEvidence(WorkflowRequest request, RepOrderDTO repOrder) {
        log.debug(
                "Creating evidence items for financialAssessmentId: {}",
    ...
    public ApplicationDTO updateEvidence(WorkflowRequest workflowRequest, RepOrderDTO repOrderDTO) {
        ...
        log.debug(
                "Updating evidence items for financialAssessmentId: {}",
                applicationDTO.getAssessmentDTO().getFinancialAssessmentDTO().getId());

        ApiUpdateIncomeEvidenceRequest evidenceRequest =
                incomeEvidenceMapper.workflowRequestToApiUpdateIncomeEvidenceRequest(
        ...
        MaatApiUpdateAssessment maatApiRequest = incomeEvidenceMapper.mapUpdateEvidenceToMaatApiUpdateAssessment(
                workflowRequest, repOrderDTO, evidenceResponse);
        MaatApiAssessmentResponse maatApiResponse = maatCourtDataApiService.updateFinancialAssessment(maatApiRequest);
