...
//    private final RestAPIClient cmaApiClient;
    private final CmaApiClient cmaApiClient;
...
//                assessmentId
//        );
        ApiGetMeansAssessmentResponse response = cmaApiClient.find(assessmentId);
...
//        );
        ...
        ApiMeansAssessmentResponse response = cmaApiClient.create(request);
        log.info(String.format(RESPONSE_STRING, response));
        return response;
    }
...
//        );
        ...
        ApiMeansAssessmentResponse response = cmaApiClient.update(request);
        log.info(String.format(RESPONSE_STRING, response));
        return response;
    }
