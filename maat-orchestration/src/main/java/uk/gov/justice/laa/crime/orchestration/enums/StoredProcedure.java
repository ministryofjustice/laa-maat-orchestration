...
public enum StoredProcedure {
    ...
    ASSESSMENT_POST_PROCESSING_PART_1(Package.ASSESSMENT, "post_assessment_processing_part_1"),
    ASSESSMENT_POST_PROCESSING_PART_2(Package.ASSESSMENT, "post_assessment_processing_part_2"),
    ASSESSMENT_POST_PROCESSING_PART_1_C3(Package.ASSESSMENT, "post_assessment_processing_part_1_c3"),
